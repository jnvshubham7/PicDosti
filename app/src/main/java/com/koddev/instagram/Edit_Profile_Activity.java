...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(view -> updateProfile(Objects.requireNonNull(fullname.getText()).toString(),
    ...
    private void updateProfile(String fullname, String username, String bio){
        ...
        Toast.makeText(Edit_Profile_Activity.this, "Successfully updated!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void uploadImage(){
        ...
        if (mImageUri != null){
            ...
            }).addOnFailureListener(e -> Toast.makeText(Edit_Profile_Activity.this, e.getMessage(), Toast.LENGTH_SHORT).show());

        } else {
            Toast.makeText(Edit_Profile_Activity.this, "No image selected", Toast.LENGTH_SHORT).show();
        }
    }
